...
#undef MENU_BTN_MASK
#define MENU_BTN_MASK (1ULL << 7)
#undef BACK_BTN_MASK
#define BACK_BTN_MASK (1ULL << 6)
#undef UP_BTN_MASK
#define UP_BTN_MASK (1ULL << 0)
#undef DOWN_BTN_MASK
#define DOWN_BTN_MASK (1ULL << 8)
#undef ACC_INT_MASK
#define ACC_INT_MASK (1ULL << 14)
#undef BTN_PIN_MASK
#define BTN_PIN_MASK                                                           \
  (MENU_BTN_MASK | BACK_BTN_MASK | UP_BTN_MASK | DOWN_BTN_MASK)
